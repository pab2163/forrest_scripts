...
singularity run \
    ...
    /rigel/psych/users/pab2163/singularity_images/cpac_1_7_august_10_2020.simg /bids_dataset /outputs participant --participant_label $sub  --pipeline_file /configs/studyforrest_pipelines.yaml --n_cpus 8 --mem_gb 20
