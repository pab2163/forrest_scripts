...
singularity run \
    ...
    /rigel/psych/users/pab2163/singularity_images/cpac_1_7_july_29_2020.simg /bids_dataset /outputs participant --participant_label $sub  --pipeline_file /configs/cpac_init.yaml --data_config_file /configs/data_config_cpac_init_default.yml --n_cpus 10 --mem_gb 20
